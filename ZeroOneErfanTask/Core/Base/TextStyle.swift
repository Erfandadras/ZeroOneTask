...
extension LocalTextStyle {
    ...
    /// one liner regular 16
    public static let largeRegular = Font.Poppins.regular(16.updateForHeight())
    
    /// one liner regular 18
    public static let xLRegular = Font.Poppins.regular(18.updateForHeight())
